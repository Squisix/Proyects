/*
    ...
    \Fecha: 18/05/21
    \brief: Archivo principal donde se manipula un ArbolBMas
*/
...
void GestionarOperaciones(unsigned seleccion, ArbolBMas<int,3> &a, ArbolBMas<int,4> &b,ArbolBMas<int,5> &c, ArbolBMas<int,6> &d,ArbolBMas<int,7> &e ,
                           FormaImpresion &metodo, unsigned &grado);
void ImprimirArbol(ArbolBMas<int,3> &a, ArbolBMas<int,4> &b,ArbolBMas<int,5> &c, ArbolBMas<int,6> &d,ArbolBMas<int,7> &e ,FormaImpresion metodo, unsigned grado);
...
void GestionarOperaciones(unsigned seleccion, ArbolBMas<int,3> &a, ArbolBMas<int,4> &b,ArbolBMas<int,5> &c, ArbolBMas<int,6> &d,ArbolBMas<int,7> &e ,
    ...
    if(grado == 3){
          switch(seleccion){
            ...
            case 7:{
                cout << "El ArbolB+ original es: " << endl << endl;
                a.Imprimir(POR_NIVEL);
                ArbolBMas<int,3> ac = a;
                cout << "\nEl ArbolB+ copia es: " << endl << endl;
                ac.Imprimir(POR_NIVEL);
                break;
            }
        ...
        switch(seleccion){
            ...
            case 7:{
                cout << "El ArbolB+ original es: " << endl;
                b.Imprimir(POR_NIVEL);
                ArbolBMas<int,4> bc = b;
                cout << "\nEl ArbolB+ copia es: " << endl;
                bc.Imprimir(POR_NIVEL);
                break;
            }
        ...
        switch(seleccion){
            ...
            case 7:{
                cout << "El ArbolB+ original es: " << endl << endl;
                c.Imprimir(POR_NIVEL);
                ArbolBMas<int,5> cc = c;
                cout << "\nEl ArbolB+ copia es: " << endl << endl;
                cc.Imprimir(POR_NIVEL);
                break;
            }
        ...
        switch(seleccion){
            ...
            case 7:{
                cout << "El ArbolB+ original es: " << endl << endl;
                d.Imprimir(POR_NIVEL);
                ArbolBMas<int,6> dc = d;
                cout << "\nEl ArbolB+ copia es: " << endl << endl;
                dc.Imprimir(POR_NIVEL);
                break;
            }
        ...
        switch(seleccion){
            ...
            case 7:{
                cout << "El ArbolB+ original es: " << endl << endl;
                e.Imprimir(POR_NIVEL);
                ArbolBMas<int,7> ec = e;
                cout << "\nEl ArbolB+ copia es: " << endl << endl;
                ec.Imprimir(POR_NIVEL);
                break;
            }
...
void ImprimirArbol(ArbolBMas<int,3> &a, ArbolBMas<int,4> &b,ArbolBMas<int,5> &c, ArbolBMas<int,6> &d,ArbolBMas<int,7> &e ,
                   FormaImpresion metodo, unsigned grado){
    if(grado == 3) {
        a.Imprimir(metodo);

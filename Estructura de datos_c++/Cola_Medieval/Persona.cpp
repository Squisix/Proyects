...
std::ostream& operator<< (std::ostream &fSalida, const Persona &p){
    fSalida << p.ObtenerNombre() << " " << p.ObtenerApellido() << "  ---  " << p.ObtenerEstamento();
    return fSalida;
}
////*****************************************************************************************//
...
Persona::Persona(){
    ...
    static char EstratoSocial[][10] = {"Noble","Plebeyo"};
    ...
    EsPlebeyo = rand()%4;
    if(EsPlebeyo) Estamento = EstratoSocial[1];
    else Estamento = EstratoSocial[0];
...
////*****************************************************************************************//
char* Persona::ObtenerEstamento() const{
    return Estamento;
}
////*****************************************************************************************//

bool Persona::ObtenerEsPlebeyo() const{
    return EsPlebeyo;
}

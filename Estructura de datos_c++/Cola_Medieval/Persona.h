...
public:
    ...
    */
    ...
    /** \brief Permite obtener el Estamento de la persona
    *   \return El Estamento de la persona
    */
    char* ObtenerEstamento() const;
    ...
    */
    ...
    bool ObtenerEsPlebeyo() const;


private:
    char *Nombre; /*< Nombre de la persona */
    char *Apellido; /*< Apellido de la persona */
    char *Estamento; /*< Indica el estamento de la persona */
    bool EsPlebeyo; /*< Indica si la persona es Plebeyo */
};

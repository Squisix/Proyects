...
public:
    ...
    */
    ...
    /** \brief Operador de Función. Copia todos los parametros de un ArbolB a otro.
    ...
    */
    ...
    /** \brief Permite insertar un dato en un ArbolB (sin repetición)
    ...
    *   \return True si la clave está en el ArbolB, false en caso contrario.
    */
    ...
    */
    ...
    /** \brief Permite conocer si un ArbolB está vacio
